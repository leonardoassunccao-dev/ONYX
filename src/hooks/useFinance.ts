...
import { collection, query, where, onSnapshot, addDoc, deleteDoc, doc, setDoc, orderBy } from 'firebase/firestore';
...
export function useFinance() {
  ...
  useEffect(() => {
    ...
    // Listen to App State (Salary/Patrimony stored in 'system/finance')
